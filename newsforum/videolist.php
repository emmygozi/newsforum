...
<div class="container-fluid">
	...
	<div class="row"  style="margin-bottom: 8em;">
						...
						<div class="col-md-4 panel panel-primary ">
							...
							<div class="embed-responsive embed-responsive-4by3 panel-heading wrapper">

								<video id="needattri" class="embed-responsive-item vid" src="videoupload/oldfreestyle.mp4" type="video/mp4" autostart= "0"  ></video>
								<i class="fa fa-play-circle-o fa-5x later" aria-hidden="true"></i>
							</div>
...
<div class="row panel panel-primary ">
						<div class="col-md-12 panel-body"><a class="list_news" href="#">
							<div class="col-xs-6" style="height: 22em; ">
								<div class="embed-responsive embed-responsive-4by3 panel-heading " >
								<div id="stopped">
								<video id="stopvid" class="embed-responsive-item vid" src="videoupload/Selectingelementstousetwo.mp4" type="video/mp4" autostart= "0"  ></video>
								</div>
								
							</div>

							</div>
							<div class="col-xs-6 more" style="height: 22em; text-align: center;">
								<h1 >qwehjksdj jxjxjx xchhcxc xchhxhh xhhxhkx khxhxc</h1>
							</div>
						</div>
					   </a>
				</div>
...
<script type="text/javascript">
				$(document).ready(function(){
					$('#stopvid').click(function(event){
						...
						$('#stopvid').parent().click(function(){
							$(this).children('#stopvid').get(0).pause();
							$('#needattri').get(0).play();
							$(".later").fadeOut();
						});
						
						var u = $('#needattri').attr('src');
						$('#needattri').attr('autostart','');
						alert(u);
					});

					$('#stopvid').dblclick(function(event){
						alert('clicked2');
						event.preventDefault();
					});
				});
